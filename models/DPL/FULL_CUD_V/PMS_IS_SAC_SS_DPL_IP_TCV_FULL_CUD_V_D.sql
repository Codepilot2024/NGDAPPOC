{{ config(
    ...
    pre_hook='CALL {{ var("PS_DB_IS_ORA_SCM_v0001.$ORA_SCM_SAC") }}.proc_truncate_table(\'{{ var("PS_DB_IS_ORA_SCM_v0001.$ORA_SCM_SAC") }}\',\'PMS_IS_SAC_SS_DPL_IP_TCV_FULL_CUD_V_D\');'
) }}
...
from {{ source('pms_cds','PMS_IS_CDS_SS_DPL_IP_TCV_FULL_CUD_V_AR_VW') }}  BALOP_5 
